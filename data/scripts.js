...
function PinoutChange()
{
	...
	if (i==8)                                                                                                                                           // показать/спрятать длину 1
	{
		ShowEl('length_1_im');
		ShowEl('length_1_in');
	} else
    ...
    if (i==9)                                                                                                                                           // показать/спрятать чуствительность
	{
		ShowEl('sensitivity_stop_r');
		ShowEl('sensitivity_stop_info');
	} else
	{
		HideEl('sensitivity_stop_r');
		HideEl('sensitivity_stop_info');
	}
